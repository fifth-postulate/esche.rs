...
fn main() {
    ...
    let picture = nonet(
        source.clone(), turn(source.clone()), turn(turn(source.clone())),
        turn(turn(turn(source.clone()))), flip(source.clone()), turn(flip(source.clone())),
        turn(turn(flip(source.clone()))), turn(turn(turn(flip(source.clone())))), source);
